...
const form = reactive({
    name: null, kana: null, tel: null, 
    email: null, postcode: null, address: null, birthday: null, gender: null, memo: null
});

const storeCustomer = () => {
    // php artisan route:listで確認
    // postメソッドで/customersを指定するとcustomersのstoreメソッドが実行される.
                            ...
                            <form @submit.prevent="storeCustomer">
                                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                    <div class="flex flex-wrap -m-2">
                                        ...
                                        <div class="p-2 w-full">
                                        <div class="relative">
                                            <label for="kana" class="leading-7 text-sm text-gray-600">顧客名かな</label>
                                        ...
                                        <div class="relative">
                                            ...
                                            <label for="gender0" class="ml-2 mr-4 leading-7 text-sm text-gray-600">男性</label>
                                            <input type="radio" id="gender1" name="gender" v-model="form.gender" value="1" >
                                            <label for="gender1" class="ml-2 mr-4 leading-7 text-sm text-gray-600">女性</label>
